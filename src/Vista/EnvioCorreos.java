...
public class EnvioCorreos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnSendEmail, jButton1});
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {btnSendEmail, jButton1});
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int resultado = JOptionPane.showConfirmDialog(this, "¿Desea calcelar?", "Cancelar envio", a);
        if (resultado == 0) {
            this.setVisible(false);
            formCobrarOrden fco = new formCobrarOrden();
            fco.setVisible(true);
